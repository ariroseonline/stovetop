  ...
  render() {
    return (
      <div className="burner-slot">
        ...
        { this.props.interest ? <DraggableInterest key={"burner-interest-" + this.props.stage} interest={this.props.interest} draggableItemType={ItemTypes.BURNER_INTEREST} displayComponent={BurnerInterest} showModal={this.props.showModal} saveInterestMetadata={this.props.saveInterestMetadata} saveInterestResource={this.props.saveInterestResource}  fetchInterestResourceType={this.props.fetchInterestResourceType} /> : null }
      </div>
    )
  }
}
